    ...
    $(document).ready(() => {
        if (window.self === window.top) {
            ...
            const createPopup = (content) => {
                ...
                let logoBox = '<img id="logoBox" src="https://i.imgur.com/fBCpZkQ.png"/>';
            ...
            let imgBox = '<img id="iconBox" src="https://i.imgur.com/NCaz8NZ.png"/>';
            ...
            const backendText = "http://127.0.0.1:80/";
            ...
            if (($("h1").filter(function () { return (privacy.test($(this).text()) || terms.test($(this).text())) })).length > 0
                ...
                fetch(backend, {method:'POST',
                     headers : new Headers({'Content-Type':'application/x-www-form-urlencoded',}),body:"link=currentUrl"})
