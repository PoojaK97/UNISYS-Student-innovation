...
App.init = function () {
	...
	// drop events
	$("#drop-area").ondragleave = function (evt) {
		$("#drop-area").classList.remove("active");
		evt.preventDefault();
	};
	$("#drop-area").ondragover = $("#drop-area").ondragenter = function (evt) {
		$("#drop-area").classList.add("active");
		evt.preventDefault();
	};
	$("#drop-area").ondrop = function (evt) {
